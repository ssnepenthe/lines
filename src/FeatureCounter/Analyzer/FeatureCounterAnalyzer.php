...
use TomasVotruba\Lines\FeatureCounter\NodeVisitor\ThrowFlaggingNodeVisitor;
...
final readonly class FeatureCounterAnalyzer
{
    ...
    public function analyze(array $fileInfos): FeatureCollector
    {
        ...
        $nodeTraverser = new NodeTraverser(new ThrowFlaggingNodeVisitor(), $featureCollectorNodeVisitor);
